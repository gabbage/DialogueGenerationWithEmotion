...
from model.enc_att import Seq2SeqAttentionSharedEmbedding
...
if __name__ == '__main__':
    ...
    for epoch in range(100):
        ...
        print("Evaluating:")
        with torch.no_grad():
            for i, (src_test, trg_test, tag_test) in enumerate(test_loader):
        ...
        torch.save(
            ...
            open(os.path.join(
                'checkpoint',
                'new_attention' + '_epoch_%d' % (epoch) + '.model'), 'wb'
            )
        )
